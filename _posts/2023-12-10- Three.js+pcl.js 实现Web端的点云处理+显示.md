---
title: Three.js+pcl.js 实现Web端的点云处理+显示.md
tags: CV
...
<img src="https://raw.githubusercontent.com/PLUS-WAVE/blog-image/master/img/blog/2023-12-09/brief.gif" alt="brief" style="zoom: 200%;" />
...
1. 创建和配置 GUI
   ...
   - 使用 `plcgui.add` 添加控件：将参数添加到 GUI 中，并使用 `onChange` 事件指定在<u>值变化时调用 `filterPointCloud` 函数</u>。
...
源码见 Github : [图像与动画实验](https://github.com/PLUS-WAVE/A-UESTCer-s-Code/tree/master/%E5%9B%BE%E5%BD%A2%E4%B8%8E%E5%8A%A8%E7%94%BB%E5%AE%9E%E9%AA%8C/%E5%AE%9E%E9%AA%8C2/src)
