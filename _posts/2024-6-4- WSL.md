...
但是！windows家庭版（windows home）是默认没有Hyper-V功能的，需要自己手动安装：<!--more-->
...
1. 下载完成后，将获得一个后缀名为 `.AppxBundle` 的文件。
   ...
   ![image-20240604192202197](https://img-blog.csdnimg.cn/img_convert/10878c74855108df1eef866dc2873882.png)

2. 将该文件的后缀改为 `.zip` 并解压。

3. 在解压后的文件夹中，将找到 `Ubuntu_2204.1.7.0_x64.appx` 的文件。

   ![image-20240604192255976](https://img-blog.csdnimg.cn/img_convert/b52a401c963cc209389889216dd310ab.png)
...
6. 在解压后的文件夹中，将找到 `ubuntu.exe` 文件。
   ...
   ![image-20240604192341461](https://img-blog.csdnimg.cn/img_convert/e485bce8a8e772de2a66dded6ee33781.png)
